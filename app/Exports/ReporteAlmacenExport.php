...
class ReporteAlmacenExport implements FromView, ShouldAutoSize, WithEvents,WithTitle 
{
    public function view(): View
    {
      ...
      ->leftJoin("articulos as a","la.articulo_id","a.id")
      ->leftJoin("lotes as l","la.lote_id","l.id")
      ...
      ->leftJoin("requisicion_has_ordencompras as  rho","pe.req_com_id","rho.id")
      ->leftJoin("ordenes_compras as oc","rho.orden_compra_id","oc.id")
      ->leftJoin("proveedores as p","oc.proveedore_id","p.id")
