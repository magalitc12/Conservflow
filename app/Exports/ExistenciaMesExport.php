...
class ExistenciaMesExport implements FromView, WithEvents
{
  ...
  public function view(): View
  {
    ...
    $mes_numero = $valores[0];
    $mes = $this->mes($valores[0]);
    $anio = $valores[1];

    // Obtene rel ultimo día del mes
    $fecha = new DateTime("$anio-$mes_numero-01");
    $aux_fecha = $anio ."-".$mes_numero."-".$fecha->format("t");
