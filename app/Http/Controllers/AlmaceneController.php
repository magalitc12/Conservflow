...
class AlmaceneController extends Controller
{
  ...
  public function index()
  {
    ...
    if ($ubicacion == null)
    {
      $almacenes = Almacene::select(
        'almacenes.id',
        'almacenes.nombre as nombre',
        'stands.id as stand_id',
        'stands.Nombre as stand',
        'niveles.id as nivel_id',
        'niveles.Nombre as nivel',
        'almacenes.condicion',
        'almacenes.ubicacion_id',
        'tipo_ubicacion.nombre AS ubicacion'
      )
  ...
  public function inventario()
  {
    ...
    $exx = Existencia::select(
      'existencias.*',
      'lotes.cantidad AS lt_cantidad',
