...
use App\SistemaModels\TiempoReportes;
use DateTime;
use Exception;
...
class ExistenciasController extends Controller
{
  ...
  public function edit($id)
  {
    ...
    // $DatosBancEmpleadoadoleado->update();
  ...
  public function excelMes($id)
  {
    ...
    {
      $valores = explode('&', $id);
      $nombre = 'ReporteMesual_' . $valores[0] . '-' . $valores[1] . '.xlsx';
      ob_end_clean();
      ob_start();
  ...
  public function excelProyecto($id)
  {
    try
    {
      ...
      $nombre = 'Reporte Proyecto ' . str_replace(' ', '', $nombre) . '.xlsx';
