        ...
        if ($request->metodo == "Nuevo")
        {
            ...
            if ($request->hasFile('poliza') || $request->hasFile('tarjeta_circulacion') || $request->hasFile('verificacion'))
            {
                if ($request->hasFile('poliza'))
                {
                    ...
                    Storage::disk('ftp')->put($PolizaStore, fopen($request->file('poliza'), 'r+'));
                }
                if ($request->hasFile('tarjeta_circulacion'))
                {
                    ...
                    //Subida del archivo al servidor ftp
                    Storage::disk('ftp')->put($TarjetaStore, fopen($request->file('tarjeta_circulacion'), 'r+'));
                }
                if ($request->hasFile('verificacion'))
                {
                    ...
                    //Subida del archivo al servidor ftp
                    Storage::disk('ftp')->put($VerificacionStore, fopen($request->file('verificacion'), 'r+'));
                }
            ...
            if ($request->hasFile('poliza') || $request->hasFile('tarjeta_circulacion') || $request->hasFile('verificacion'))
            {
                if ($request->hasFile('poliza'))
                {
                    ...
                    if ($ValorPoliza != '')
                    {
                        ...
                        Storage::disk('ftp')->delete($ValorPoliza);
                    }
                }
                if ($request->hasFile('tarjeta_circulacion'))
                {
                    ...
                    {
                        //Elimina el archivo en el servidor si requiere ser actualizado
                        Storage::disk('ftp')->delete($ValorTarjeta);
                    }
                }
                if ($request->hasFile('verificacion'))
                {
                    ...
                    {
                        //Elimina el archivo en el servidor si requiere ser actualizado
                        Storage::disk('ftp')->delete($ValorVerificacion);
                    }
                }
