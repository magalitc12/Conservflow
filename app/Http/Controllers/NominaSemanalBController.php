...
class NominaSemanalBController extends Controller
{
    ...
    if ($fecha_inicial == 'null' && $fecha_final == 'null' && $proyecto_id == 0)
    {
      ...
      if ($tipo == 1)
      {
        ...
        $nomina = DB::table('nominas_movimientos')
          ...
          ->select(
            'nominas_movimientos.dias_trabajados',
            'nominas_movimientos.efectivos',
            'P.nombre AS nombrep',
            'nominas_movimientos.efectivos AS valor',
            'nominas_movimientos.totales',
            DB::raw("CONCAT(E.nombre,' ',E.ap_paterno,' ',E.ap_materno) AS e_nombre")
          )->where('C.tipo_nomina_id', '=', '1')->get();
        $sumauno = DB::table('nominas_movimientos')
          ...
          ->where('C.tipo_nomina_id', '=', '1')->first();
        $arreglo[] =
          [
            'condicion' => '1',
            'movimientos' => $nomina,
      ...
      if ($tipo == 2)
      {
        ...
        $nomina = DB::table('nominas_movimientos')
          ...
          ->select(
            'nominas_movimientos.dias_trabajados',
            'P.nombre AS nombrep',
            'nominas_movimientos.transferencias',
            'nominas_movimientos.transferencias AS valor',
            'nominas_movimientos.totales',
            DB::raw("CONCAT(E.nombre,' ',E.ap_paterno,' ',E.ap_materno) AS e_nombre")
          )->where('C.tipo_nomina_id', '=', '1')->get();
        $sumauno = DB::table('nominas_movimientos')
    ...
    if ($fecha_inicial == 'null' && $fecha_final == 'null' && $tipo == 0)
    {
      ...
      $nomina = DB::table('nominas_movimientos')
        ...
        ->select(
          ...
          'P.nombre AS nombrep',
          DB::raw("CONCAT(E.nombre,' ',E.ap_paterno,' ',E.ap_materno) AS e_nombre")
        )->where('C.tipo_nomina_id', '=', '1')->where('P.id', '=', $proyecto_id)->get();
      $sumauno = DB::table('nominas_movimientos')
        ->leftJoin('empleados AS E', 'E.id', '=', 'nominas_movimientos.empleado_id')
        ->leftJoin('contratos AS C', 'C.id', '=', 'nominas_movimientos.contrato_id')
        ->leftJoin('proyectos AS P', 'P.id', '=', 'nominas_movimientos.proyecto_id')
        ...
        ->where('C.tipo_nomina_id', '=', '1')->where('P.id', '=', $proyecto_id)->first();
      if (count($nomina) != 0)
      {
        $arreglo[] =
          [
    ...
    if ($fecha_inicial != 'null' && $fecha_final != 'null' && $proyecto_id != 0 && $tipo == 0)
    {
      ...
      $nomina = DB::table('nominas_movimientos')
        ...
        ->select(
          ...
          'P.nombre AS nombrep',
          DB::raw("CONCAT(E.nombre,' ',E.ap_paterno,' ',E.ap_materno) AS e_nombre")
        )->where('C.tipo_nomina_id', '=', '1')->where('P.id', '=', $proyecto_id)
        ->whereBetween('N.fecha_final', [$fecha_inicial, $fecha_final])
      ...
      { //efectivos
        $nomina = DB::table('nominas_movimientos')
          ...
          ->select(
            ...
            'nominas_movimientos.totales',
            DB::raw("CONCAT(E.nombre,' ',E.ap_paterno,' ',E.ap_materno) AS e_nombre")
          )->where('C.tipo_nomina_id', '=', '1')->whereBetween('N.fecha_final', [$fecha_inicial, $fecha_final])
