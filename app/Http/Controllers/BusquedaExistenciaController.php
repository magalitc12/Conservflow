    ...
    if ($proyecto_id == 0 && $ubicacion_id == 0 && $stand_id == 0 && $nivel_id == 0)
    {
      ...
      $articulo = DB::table('existencias')
        ->select(
          ...
          'articulos.descripcion as art_desc',
          'almacenes.ubicacion_id as alm_ub',
          'niveles.nombre as niv_nom',
          'stands.nombre as stand_nomb',
          'tipo_ubicacion.nombre as tu_n',
          'proyectos.nombre as prnom',
          'almacenes.nombre as alm_nom',
          'p.precio_unitario as punit',
          DB::raw('(existencias.cantidad * p.precio_unitario) AS Precio')
        )
        ->leftJoin('articulos', 'articulos.id', '=', 'existencias.articulo_id')
