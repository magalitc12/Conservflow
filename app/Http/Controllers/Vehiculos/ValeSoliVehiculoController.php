...
use App\VehiculosModels\ValeSoliVehiculo;
...
class ValeSoliVehiculoController extends Controller
{
    ...
    public function Descargar($id)
    {
        try
        {
            ...
            $pdf = $vale->empresa == 1 ? "pdf.vehiculosvaleresguardoconser" : "pdf.vehiculosvaleresguardo";
            $pdf = PDF::loadView($pdf, compact("vale", "fecha"));
