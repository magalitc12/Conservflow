...
namespace App\Http\Controllers\APIAlmacen;
    ...
    public function ObtenerProyectos()
    {
        try
        {
            $proyectos = Proyecto::where("condicion", "=", 1)
                ->join("proyecto_subcategorias as ps2", "ps2.id", "proyectos.proyecto_subcategorias_id")
                ->join("proyecto_categorias as pc", "pc.id", "ps2.proyecto_categoria_id")
                ->where("pc.id", 1)
                ->select("proyectos.id", "nombre_corto")
