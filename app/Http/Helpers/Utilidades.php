...
class Utilidades
{
  ...
  /**
   * Crear un folio
   * @param string $tipo tipo de requisicion
   * @param int $proyecto_id id del proyecto
   */
  public static function folioRequisicion($tipo, $proyecto_id)
  {
    $folio = "";
    $n = 0;
    $anio = date("Y");
    ...
    {
      case "REQ":
        $n = Requisicion::withTrashed()->byProyecto($proyecto_id)->count() + 1;
        break;
      default:
        throw new Exception("Tipo de Folio no encontrado: $tipo", 1);
        break;
    }
