<template>
  <main>
    <button v-show="empleado_activo" type="button" v-bind:disabled="deshabilitado == 1" @click="abrirModal('direccion','registrar', empleado.id)" class="btn btn-dark float-sm-right">
        ...
        <div class="modal-content">
          <div>
            ...
            <div class="modal-footer">
              ...
              <button v-show="empleado_activo" type="button" v-if="tipoAccion==1" class="btn btn-secondary" @click="guardarDirecciones(1)"><i class="fas fa-save"></i>&nbsp;Guardar</button>
              <button v-show="empleado_activo" type="button" v-if="tipoAccion==2" class="btn btn-secondary" @click="guardarDirecciones(0)"><i class="fas fa-save"></i>&nbsp;Actualizar</button>
            </div>
          </div>
        </div>
        <!-- /.modal-content -->
