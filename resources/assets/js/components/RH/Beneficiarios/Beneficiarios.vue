<template>
  <main>
    <button v-show="empleado_activo" type="button" v-bind:disabled="deshabilitado == 1" @click="abrirModal('beneficiario','registrar', empleado.id)" class="btn btn-dark float-sm-right">
      ...
      <v-client-table :columns="columnsbeneficiario" :data="tableDatabeneficiario" :options="optionsbeneficiario" ref="myTabledireccion">
        ...
        <template v-if="props.row.condicion">
            <button v-show="empleado_activo" type="button" class="dropdown-item" 
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-footer">
                     <vue-element-loading :active="isLoading"/>
                      ...
                      <button v-show="empleado_activo" type="button" v-if="tipoAccion==1" class="btn btn-secondary" @click="guardarbeneficiario(1)"><i class="fas fa-save"></i>&nbsp;Guardar</button>
                      <button v-show="empleado_activo" type="button" v-if="tipoAccion==2" class="btn btn-secondary" @click="guardarbeneficiario(0)"><i class="fas fa-save"></i>&nbsp;Actualizar</button>
                  </div>
                  </div>
              </div>
              <!-- /.modal-content -->
