                    ...
                    <div class='modal-body'>
                        <div class="form-row">
                            ...
                            <div class="col-md-9 mb-3">
                                ...
                                <v-select :options="listaCatalogo" v-model="caiv" label="descripcion" data-vv-name="material" @search="buscar" @input="asignar()">
                                </v-select>
                            </div>
                        </div>
                        <div class="form-row">
...
export default
{
    ...
    methods:
    {
        getDataI()
        {
            axios.get('ti/programanamtto/obtenerprogramas/' + this.company).then(response =>
            {
        ...
        verdetalle(anio)
        {
            ...
            axios.get('ti/programanamtto/obtenerequipos' + anio + '&' + this.company).then(response =>
            {
                this.detalle = true;
        ...
        eliminar(id)
        {
            ...
            }).then(result =>
            {
                if (result.value)
                {
                    axios.get('ti/programanamtto/eliminar/' + id).then(response =>
                    {
                        this.verdetalle(this.anio_busqueda);
                    }).catch(e =>
                    {
