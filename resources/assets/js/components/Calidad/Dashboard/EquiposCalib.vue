                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="col-md-10 mb-3">
                                ...
                                <input type='text' class='form-control' disabled v-model='calibracion_modal.descripcion'>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                <label>Marca</label>
                                <input type='text' class='form-control' disabled v-model='calibracion_modal.marca'>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label>Modelo</label>
                                <input type="text" class="form-control" disabled v-validate="'required'" data-vv-name="Modelo" v-model="calibracion_modal.modelo">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label>No. Serie</label>
                                <input type='text' class='form-control' disabled v-model='calibracion_modal.numero_serie'>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-10 mb-3">
                                <label>Rango Medición</label>
                                <input type="text" class="form-control" disabled v-validate="'required'" data-vv-name="Rango Medición" v-model="calibracion_modal.rango_medicion">
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control" disabled v-model="calibracion_modal.frecuencia" v-validate="'required'" data-vv-name="Frecuencia">
                            ...
                            <template v-if="calibracion_modal.frecuencia != '' && calibracion_modal.frecuencia != '2'">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" class="form-control" disabled v-validate="'required'" data-vv-name="Fecha Servicio" v-model="calibracion_modal.fecha_servicio" @change="cambiarFecha()">
                                    <span class="text-danger">{{errors.first('Fecha Servicio')}}</span>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label>Proxima fecha</label>
                                    <input type="date" class="form-control" disabled v-validate="'required'" data-vv-name="Proxima Fecha" v-model="calibracion_modal.proxima_fecha">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" disabled v-model="calibracion_modal.resguardo">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Observaciones</label>
                                <input type="text" class="form-control" disabled v-model="calibracion_modal.observaciones">
                            </div>
                        </div>
