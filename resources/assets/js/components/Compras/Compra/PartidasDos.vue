    ...
    <form>
      ...
      <div class="form-row">
        <div class="form-group col-md-8">
          ...
          <div class="input-group">
            <textarea name="name" v-model="partidascompras.nombrearti" v-bind:class="'form-control'+clases.nombrearti" rows="4" cols="80" readonly></textarea>
      ...
      <div class="form-row">
        <div class="form-group col-md-8">
          ...
          maxlength="75" v-validate="'max:75'"
           title="Texto que aparecera en el formato!"
           v-model="partidascompras.comentario" autocomplete="off" id="comentario" rows="4"></textarea>
        </div>
      </div>
