...
<div>
    ...
    <div class="card" v-if="detalle == 1">
        <div class="card-header">
            <i class="fa fa-align-justify"></i> ORDENES DE COMPRA
        ...
        <div class="card-body">
            ...
            <v-server-table :columns="columns" :url="'compras/busqueda/'+objeto" :options="options" ref="myTable">
                        ...
                        <div class="btn-group dropup" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                ...
                                <template v-if="props.row.condicion == 1 || props.row.condicion == 2 ">
                                    <a v-show="PermisosCrud.Download" class="dropdown-item" @click="descargarn(props.row)" href="#">
                ...
                <template slot="descargar" slot-scope="props">
                    <button :disabled="!PermisosCrud.Create" class="btn btn-outline-dark" @click="cargardetalle(props.row)">
                        <i class="fas fa-list"></i>&nbsp;Partidas
                    </button>
                </template>
                <template slot="format" slot-scope="props">
                    <template v-if="props.row.condicion == 1 || props.row.condicion == 2 ">
                        <button :disabled="!PermisosCrud.Download" class="btn btn-outline-dark" @click="descargarn(props.row)">
    ...
    <div v-show="widgets.cardprincipal">
        <cardprincipal ref="cardprincipal" @cardprincipal:click="cerrar($event)" @cardprincipalcerrarmodal:click="cerrar()" @cardprincipaluno:click="cerrarprincipal($event)" @comprascerrarmodal:click="cerrarModalActualizar()"></cardprincipal>
    </div>
