    ...
    <div class="container-fliud">
        ...
        <div class="card" v-if="detalle == 1">
            <div class="card-header">
                ...
                <button v-show="PermisosCrud.Create" type="button" @click="abrirModal('compra','registrar')" class="btn btn-dark float-sm-right">
                        ...
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            <div class="btn-group dropup" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    ...
                                    <button type="button" @click="verdetalles(props.row)" class="dropdown-item">
        ...
        <div v-show="detalle == 3">
            <cardprincipal ref="cardprincipal" @cardprincipal:click="cerrar($event)" @cardprincipalproceso:click="cerrardos($event)" @cardprincipalprocesodos:click="cerrartres($event)" @cardprincipalcerrarmodal:click="cerrarModal()"></cardprincipal>
        </div>
