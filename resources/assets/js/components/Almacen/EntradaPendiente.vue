    ...
    <div class="">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <button v-show="PermisosCrud.Download" @click="DescargarReporte()" class="btn btn-dark float-sm-right">
                ...
                <fieldset>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <v-select :options="listaProveedor" v-validate="'required'" v-model="partida_entrada.proveedor" label="razon_social" name="proveedor" data-vv-name="Proveedor"></v-select>
...
export default
{
    data()
    {
        return {
            ...
            modal_asc: 0,
            tableData: [],
            columns: ['id', "folio", 'status', 'descripcion', 'cantidad', 'nombre_corto'],
            options:
            {
                headings:
                {
    ...
    methods:
    {
        ...
        getListas()
        {
            ...
            let me = this;
            axios.get("generales/proveedores/activos").then(res =>
            {
                if (res.data.status)
                {
                    me.listaProveedor = res.data.proveedores;
                }
                else
                {
        ...
        guardarDatosAsc()
        {
            ...
            {
                poc: this.id_par_req_oc, // Id rhoc
                cantidad: this.cantidad_asc, // Cantidad
                ep_id: this.ep_id, // Id EP
            }).then(res =>
            {
                if (res.data.status)
                {
        ...
        /**
         * Descargar el reporte de las Entradas Pendientes
         */
        DescargarReporte()
        {
            window.open("almacen/ep/reporte");
        },
