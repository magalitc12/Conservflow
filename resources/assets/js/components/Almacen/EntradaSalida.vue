...
<main class="main">
    <div class="">
        <div v-if="seccionMostar==1" class="card">
            <div class="card-header">
                ...
                <button v-if="PermisosCRUD.Download" type="button" class="btn btn-dark float-sm-right" @click="Descargar()">
            ...
            <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <div class="form-group row disabled">
                            ...
                            <div class="col-md-8">
                                <div class="input-group mb-3">
                                    <input type="number" class="form-control disabled" placeholder="Cantidad" min="0" step="1" v-model="articuloCantidaddSalida" disabled>
                                </div>
                            </div>
                        </div>
              ...
              <input type="date" v-validate="'required'" name="fecha" v-model="fechaRetorno" class="form-control" placeholder="Fecha de Entrada" autocomplete="off" id="fecha">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <v-select v-model="proyectoPartidas" v-validate="'required'" label="nombre_corto" name="proyecto" data-vv-name="proyecto" disabled>
                                </v-select>
                            </div>
                        </div>
                    </form>
    ...
    <div class="modal fade" tabindex="-1" :class="{'mostrar' : mostrarModalEntrada}" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                ...
                <div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="date" v-validate="'required'" name="fecha" v-model="fecha" class="form-control" placeholder="Fecha de Entrada" autocomplete="off" id="fecha">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="comentarios" v-validate="'required'" v-model="comentarios" class="form-control" placeholder="Comentarios" autocomplete="off" id="comentarios">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion==2" class="btn btn-secondary" @click="guardarEntrada(2)"><i class="fas fa-save"></i>&nbsp;Actualizar</button>
                    </div>
                </div>
            </div>
            <!-- /.modal-content -->
...
export default
{
    ...
    methods:
    {
        ...
        Descargar()
        {
          window.open("almacen/reportes/retornosgeneral","_blank")
        },
