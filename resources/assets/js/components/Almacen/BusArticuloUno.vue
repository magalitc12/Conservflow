        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class='form-group row'>
                    ...
                    <div class='col-md-8'>
                        <input type="text" v-model="busqueda" class="form-control" @keyup.enter="buscar()">
                    </div>
                    <button class="btn btn-dark btn-sm" @click="buscar"> Buscar
                        <i class="fas fa-button"></i>
                    </button>
                </div>

                <v-client-table ref="myTable" :data="tableData" :columns="columns" :options="options" @row-click="seleccionarArticulo2">
...
export default
{
    ...
    methods:
    {
        ...
        {
            // alert('s');
            axios.post('/buscar/articulos/',
            {
                articulo: this.busqueda
            }).then(response =>
            {
