...
<main class="main">
    <div>
        ...
        <div class="card" v-show="!detalleex" style="min-height:60vh">
                ...
                <div class="form-group row">
                    ...
                    <template v-if="buscarpor.id == 4">
                        ...
                        <div class="col-md-5">
                            ...
                            <template v-if="proyectos!=null">
                              <textarea v-show="proyectos.nombre_largo!=null" type="text" disabled class="form-control" v-model="proyectos.nombre_largo">
                              </textarea>
                            </template>
                        </div>
                    </template>
                    ...
                    <button style="max-height:2rem" v-if="buscarpor!=null && buscarpor.id ==4" type="button" class="btn btn-sm btn-success" @click="descargarproyecto">
                        <i class="fas fa-file-excel"></i>
...
export default
{
    ...
    methods:
    {
        ...
        crearBusqueda()
        {
            ...
            else if (this.buscarpor.id == 2)
            { //ALMACEN

            }
            else if (this.buscarpor.id == 3)
            { //MES

            }
            else if (this.buscarpor.id == 4)
            { //PROYECTO

            }
            else if (this.buscarpor.id == 5)
            { //GENERAL
