    ...
    <div class="">
        <div class="card" style="min-height:60vh;">
            <div class="card-header">
                ...
                <button v-if="PermisosCrud.Create" type="button" @click="abrirModal(['proyecto','registrar'])" class="btn btn-dark float-sm-right">
                    <i class="fas fa-plus"></i>&nbsp;Nuevo
                </button>
                <button v-if="PermisosCrud.Download" type="button" @click="Descargar" class="btn btn-dark float-sm-right mr-1">
                    <i class="fas fa-download"></i>&nbsp;Descargar
                </button>
            </div>
            <div class="card-body">
                <vue-element-loading :active="isProyectos_loading" />
                <v-client-table ref="myTable" :columns="columns" :data="tableData" :options="options">
                    ...
                    <template slot="folio" slot-scope="props">
                        <p v-if="props.row.folio==null">N/D</p>
                        <p v-else>{{props.row.folio}}</p>
                    </template>

                    <template slot="total_oc" slot-scope="props">
                        <template>
                            <button class="btn btn-outline-dark btn-sm">{{props.row.total_oc}}</button>
                        </template>
                    </template>
                    <template slot="total_req" slot-scope="props">
                        <template>
                            <button class="btn btn-outline-dark btn-sm">{{props.row.total_req}}</button>
                        </template>
                    </template>
                </v-client-table>
            </div>
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="form" v-if="tipoAccion==1">
                            <div class="form-group row">
                                <label class="col-md-2 " for="text-input">Nombre real del Proyecto</label>
                                <div class="col-md-4">
                                    <input type="text" v-validate="'required|max:300'" name="nombre" v-model="nombre" class="form-control" placeholder="Nombre" rows="4" cols="80" autocomplete="off" />
                            ...
                            <template v-if="deshabilitar">
                                <div class="form-group row">
                                    <label class="col-md-2 " for="text-input">Número de Cotización</label>
                                    <div class="col-md-4">
                                        <input type="text" v-validate="'required|max:30'" name="cotizacion" v-model="cotizacion" class="form-control" placeholder="Número de Cotización">
                                        <span class="text-danger">{{ errors.first('cotizacion') }}</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2 " for="text-input">Número de Orden de Compra</label>
                                    <div class="col-md-4">
                                        <input type="text" v-validate="'required|max:30'" name="no_oc" v-model="clave" class="form-control" placeholder="Número de Orden de Compra">
                                        <span class="text-danger">{{ errors.first('no_oc') }}</span>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-md-2 " for="text-input">Moneda</label>
                                    <div class="col-md-4">
                                        <select class="form-control" v-model="moneda" v-validate="'required'">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-2 " for="text-input">Nombre corto del Proyecto</label>
                                    <div class="col-md-4">
                                        <input type="text" v-validate="'required|max:40'" name="nombre_corto" v-model="nombre_corto" class="form-control" placeholder="Nombre para las Ordenes de Compra" rows="4" cols="80" />
                        ...
                        <div class="form" v-if="tipoAccion==2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="name" v-model="nombre" class="form-control" placeholder="Nombre" rows="4" cols="80" />
                                    <span class="text-danger">{{ errors.first('nombre') }}</span>
                                </div>
                            ...
                            <div class="form-group row">
                                <label class="col-md-2 " for="text-input">Nombre Folio</label>
                                <div class="col-md-4">
                                    <textarea :disabled="actualizar" name="name" v-model="nombre_corto" class="form-control" placeholder="FOLIO CORTO" rows="4" cols="80"></textarea>
                                    <span class="text-danger">{{ errors.first('nombre_corto') }}</span>
                                </div>
                                <label class="col-md-2 " for="text-input">Ciudad</label>
                                <div class="col-md-4">
                ...
                <div class="modal-body">
                    <div class="form-row">
                        <div class="col-md-4">
                            ...
                            <li :key="vi.id" v-for="(vi) in tableDocumentosProyectos" class="list-group-item">
                                <div class="form-row">
...
export default
{
    ...
    methods:
    {
        ...
        listar()
        {
            ...
            axios.get('proyectos/obtener/conoc').then(response =>
                {
