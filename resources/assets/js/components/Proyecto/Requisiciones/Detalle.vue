        ...
        <div class="card-body" id="formulario">
            <form>
                ...
                <div class="form-group row">
                    <label for="inputArticulo" class="col-md-2 form-control-label">Articulo/Servicio</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group row">
                    <label class="col-md-2 form-control-label" for="comentario">Comentario</label>
                    <div class="col-sm-6">
                        <textarea type="text" rows="5" name="comentario" :maxlength="max_comentarios" v-validate="'max:'+max_comentarios" class="form-control" aria-label="With textarea" v-model="preq.comentario" autocomplete="off" id="comentario"></textarea>
                ...
                <div class="form-group row">
                    ...
                    <label class="col-md-2 form-control-label" for="fecha_requerido">Fecha Requerida</label>
                    <div class="col-sm-2">
                ...
                <div class="form-group row">
                    <label class="col-md-2 form-control-label pr-1" for="equivalente">Equivalente</label>
                    <div class="col-md-2">
                ...
                <div class="form-group row">
                    <label for="inputArticulo" class="col-md-2 form-control-label">Documentos Requeridos</label>
                    <div class="col-md-9">
                        <div class="input-group mb-3">
            ...
            <div class="modal-content">
                <div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <div :key="i" class="col-md-4" v-for="(doc,i) in documentos">
                                    <div class="form-ch eck checkbox">
                                        ...
                                        <label class="form-check-label" for="doc.id">
                                            {{doc.nombre.replace("Certificado","Cert.")}}
                                        </label>
                                    </div>
                                </div>
                            </div>
...
export default
{
    ...
    methods:
    {
        ...
        seleccionarArticulo2(data)
        {
            ...
            this.preq.nombrearti = `${data.row.nombre} ${data.row.descripcion}`;
            me.cerrarModal();
        },
