                        ...
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            <div class="btn-group dropup" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    <button type="button" v-show="props.row.timbrado == 0" @click="abrirModal(false,props.row)" class="dropdown-item">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Cliente </label>
                                    <v-select id="cliente" name="cliente" v-model="cliente" :options="Clientes" @input="llenarDatosCliente" v-validate="'required'" label="nombre">
                                    </v-select>
                                </div>
                                <div class="form-group col-md-4">
