        ...
        <div class="card-body">
            <v-server-table :url="'partidafactura/'+ id_factura" :columns="columns" :options="options" ref="Tablac">
                    ...
                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                        <div class="btn-group dropup" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                ...
                                <button type="button" @click="modalObservaciones(props.row)" class="dropdown-item">
                ...
                <template slot="descripcion" slot-scope="props">
                    ...
                    <span v-if="props.row.observaciones">
        ...
        <div class="modal-dialog modal-dark modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-8">
                            ...
                            <v-select :options="list_produc_serv" id="productos servicios" v-validate="'required'" name="productos servicios" v-model="partidas.productos_servicios_id" label="nombre" data-vv-name="productos servicios"></v-select>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" v-model="partidas.unidad_id" data-vv-name="clave unidad" v-validate="'required'">
                                <option :key="index" v-for="(item,index) in Unidad" :value="item.id">{{item.c_unidad}} {{item.nombre}}</option>
                            </select>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" v-model="partidas.cantidad" placeholder="Cantidad" @input="multiplicar()" v-validate="'required|decimal:2'" data-vv-name="cantidad">
                            <span class="text-danger">{{errors.first('cantidad')}}</span>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Unidad </label>
                            <input type="text" class="form-control" v-model="partidas.unidad" placeholder="Unidad" data-vv-name="unidad" v-validate="'required'">
                            <span class="text-danger">{{errors.first('unidad')}}</span>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Número de identificación </label>
                            <input type="text" class="form-control" v-model="partidas.numero_identificacion" placeholder="Número de identificación" data-vv-name="numero de identificacion" v-validate="'required'">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea rows="4" cols="50" class="form-control" v-model="partidas.descripcion" placeholder="Descripción" data-vv-name="descripcion" v-validate="'required'" maxlength="1000" />
              ...
              <div class="form-group row">
                <label class="ml-2 col-md-4 form-control-label" for="nombre">Objeto de impuesto</label>
                <div class="col-md-7">
                    <select class="form-control" v-model="partidas.obj_imp">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control" v-model="partidas.descuento_porcentaje"
                placeholder="Descuento" data-vv-name="descuento" v-validate="'required|decimal:2'" @input="MultiplicarPorcentaje()">
                <span class="text-danger">{{errors.first('descuento')}}</span>
              </div>
...
export default
{
    ...
    methods:
    {
        ...
        ObtenerProductosServicios()
        {
            ...
            axios.get('/satcatprodser1').then(response =>
            {
                if (response.data.status)
                {
                    this.list_produc_serv = response.data.productoServicio;
                }
                else
                {
        ...
        MultiplicarPorcentaje()
        {
            ...
            let porcentaje = this.partidas.descuento_porcentaje;
            let total = (this.partidas.cantidad * this.partidas.valor_unitario);
         ...
         */
        async modalObservaciones(partida)
        {
