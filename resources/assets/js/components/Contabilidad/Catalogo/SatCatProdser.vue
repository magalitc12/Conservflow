...
<main class="main">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <vue-element-loading :active="isLoading_datos" />

            <div class="card-body">

                <v-client-table :columns="columns" :data="list_productos" :options="options" ref="myTable">
...
export default
{
    ...
    methods:
    {
        getData()
        {
            ...
            {
                this.isLoading_datos = false;
                if (response.data.status)
                {
                    this.list_productos = response.data.productoServicio;
                }
                else
                {
