                        ...
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            <div class="btn-group dropup" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    <template>
                                        <button type="button" @click="abrirModal( (props.row.es_menu) ? 'menu' : 'submenu','actualizar',props.row)" class="dropdown-item">
                                    ...
                                    <template>
                                        ...
                                        <button type="button" class="dropdown-item" @click="Desactivar(props.row)">
