...
<div class='main'>
    ...
    <div class='card'>
        ...
        <div class='card-header'>
            <i class="fa fa-align-justify"></i> Mantenimiento Vehicular {{empresa == 1  ? 'CONSERFLOW' : 'CSCT'}}
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                    ...
                    <button class="dropdown-item" type="button" @click="empresa = 3;getDataInicial();getData();">Diego Cruz M.</button>
                    <button class="dropdown-item" type="button" @click="empresa = 4;getDataInicial();getData();">Ramón Cruz M.</button>
                </div>
            </div>
                ...
                <div class=''>
                    <v-client-table :columns='columns_mantenimiento' :data='list_mantenimiento' :options='options_mantenimiento' ref='tbl_mantenimiento'>
                        ...
                        <template slot='tipo' slot-scope='props'>
                            <button v-if="props.row.tipo==1" type='button' class='btn btn-outline-success'>
                                Preventivo
                            </button>
...
export default
{
    ...
    methods:
    {
        ...
        getData()
        {
            ...
            {
                if (res.data.status)
                    this.listaCatalogo = res.data.unidades;
                else
