                        ...
                        <div class="form-row">
                          <div class="col-md-3 mb-3">
                            ...
                            <select class="form-control" v-model="llantas.uno">
                              ...
                              <option value="LISA">LISA</option><option value="3/4 VIDA">3/4 VIDA</option>
                            </select>
                          </div>
                          <div class="col-md-3 mb-3">
...
export default{
  ...
  methods : {
    getData(){
      axios.get('vehiculos/unidades/obtener/3').then(response => {
        this.listaCatalogo = response.data.unidades;
      }).catch(e => {
        console.error(e);
      });
