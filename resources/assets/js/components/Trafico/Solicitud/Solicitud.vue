...
<div class='main'>
    ...
    <div class='card'>
        ...
        <div class='card-header'>
            <i class='fa fa-align-justify'></i> Solicitud de vehiculos - {{empresa==1?"CONSERFLOW":"CSCT"}}
                ...
                <div class='modal-body'>
                    ...
                    <div class='form-horizontal'>
                        ...
                        <div class="container-fluid">
                            ...
                            <li :key="index" v-for="(responsable, index) in lista_responsables" class="list-group-item">
                                <div class="form-row">
...
export default
{
    ...
    methods:
    {
        ...
        ObtenerTiposUnidad()
        {
            axios.get("vehiculos/solicitud/clasetipo").then(res =>
            {
                if (res.data.status)
