            ...
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                        ...
                        <div class='form-group row'>
                            ...
                            <div class='col-md-3'>
                                <select class="form-control col" v-model="anual_modal.mes">
                                    <option :key="index" v-for="(mes,index) in list_meses" :value="mes">{{ObtenerMes(mes)}}</option>
                                </select>
                    ...
                    <div class='form-group row'>
                        ...
                        <div class='col-md-10'>
                            <textarea type='text' v-validate="'required'" class='form-control' v-model='anual_modal.observaciones' data-vv-name='observaciones'> </textarea>
                        </div>
                    </div>
                </div>
