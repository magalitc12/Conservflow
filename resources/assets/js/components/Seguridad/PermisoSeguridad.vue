...
<main class="main">
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <vue-element-loading :active="isPermisos_loading" />
                <v-client-table :data="tableData" :columns="columns" :options="options">
                    <template v-if="props.row.uno.condicion==1" slot="uno.id" slot-scope="props">
                    ...
                    <template slot="descarga" slot-scope="props">
                        <button v-if="props.row.uno.condicion==1" type="button" @click="descargar(props.row.uno.id)" class="btn btn-outline-dark">
                            <i class="fas fa-download"></i>&nbsp;<i class="fas fa-file-pdf"></i>
                        </button>
                        <button v-if="props.row.uno.condicion==0" type="button" class="btn btn-outline-danger">
                            Eliminado
                        </button>
                    </template>
                ...
                <div class="modal-content">
                    <div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-row">
                                <div class="col-md-8 mb-3" v-show="tipoAccion==1">
                                    <label>Proyecto</label>
                                    <v-select label="nombre_corto" :options="list_proyectos" v-validate="'required'" v-model="proyecto" data-vv-name="Proyecto">
                                    </v-select>
                                    <span class="text-danger">{{errors.first('Proyecto')}}</span>
                                </div>
                                <div class="col-md-4 mb-3" v-show="tipoAccion==2">
                                    <label> Folio</label>
                                    <input readonly maxlength="60" type="text" class="form-control" v-model="uno.uno">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    <label> Asociado</label>
                                    <input maxlength="20" type="text" class="form-control" v-model="uno.dos" data-vv-name="Asociado">
                            ...
                            <div class="form-row">
                                <div class="col-md-5 mb-3">
                                    ...
                                    <input maxlength="60" type="text" v-validate="'required'" class="form-control" v-model="uno.cuatro" data-vv-name="Folio">
                                    <span class="text-danger">{{errors.first('Folio')}}</span>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label> Ubicación</label>
                                    <input maxlength="60" type="text" class="form-control" v-model="uno.cinco" data-vv-name="Asociado">
                                    <span class="text-danger">{{errors.first('Asociado')}}</span>
                                </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <nav>
                                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                    ...
                                                    <a class="nav-item nav-link" id="nav-profile-ta b" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">EQUIPO DE PROTECCIÓN PERSONAL </a>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion">
                                        <div class="card-body">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    <label>Responsable de SSMA</label>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseSeis" class="collapse" aria-labelledby="headingSeis" data-parent="#accordion">
                                        <div class="card-body">
                                            ...
                                            <li :key="index" v-for="(vi, index) in once" class="list-group-item">
                                                <div class="form-row">
...
export default
{
    ...
    methods:
    {
        ...
        ObtenerProyectos()
        {
            axios.get("seguridad/permisotrabajo/obtenerproyectos").then(res =>
            {
                if (res.data.status)
                {
        ...
        ObtenerFolios()
        {
            axios.get("seguridad/permisotrabajo/obtenerfolios").then(res =>
            {
                if (res.data.status)
                {
                    this.list_folios = res.data.folios;
                    this.list_folios.unshift(
                    {
                        id: 0,
                        folio: "NUEVO"
                    });
        ...
        Validar()
        {
            let mensaje = "";
            let status = false;
            if (this.ocho.uno == null) mensaje = "Residente de Obra";
            else if (this.ocho.uno.id == null) mensaje = "Residente de Obra";
            else if (this.ocho.tres == null) mensaje = "Supervisor de Trabajo";
            else if (this.ocho.tres.id == null) mensaje = "Supervisor de Trabajo";
            else if (this.ocho.cinco == null) mensaje = "Responsable de SSMA";
            else if (this.ocho.cinco.id == null) mensaje = "Responsable de SSMA";
            else status = true;
