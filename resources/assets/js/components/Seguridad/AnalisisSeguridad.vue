                        ...
                        <div class="modal-body">
                            ...
                            <li v-for="(vi, index) in listado_data" class="list-group-item">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-2">
                                        <a v-if="vi.temp" @click="deleteu(index)">
                                            <span class="fas fa-trash" arial-hidden="true"></span>
                                        </a>
                                        <a v-else @click="BorrarRiesgo(vi.id)">
                                            <span class="fas fa-trash" arial-hidden="true"></span>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label>Responsable del Área (SSMA)</label>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <v-select v-model="empleado" :options="vs_options" label="name" data-vv-as="shso"></v-select>
                                    <!---->
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label>&nbsp;</label><br>
        ...
        BorrarRiesgo(id)
        {
            ...
            }).then(res =>
            {
                if (res.data.status)
                {
                    ...
                    //mostrar nuevos
                    this.listado_data = []; // Limpiar para duplicados
                    this.listado_supervisor = [];
                    this.listado_id = [];
                    res.data.riesgos.forEach((item, i) =>
                    {
                        this.listado_data.push(
                        {
                            id: item.id,
