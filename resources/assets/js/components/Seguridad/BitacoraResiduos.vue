              ...
              <div class="modal-body">
                  ...
                  <div class="col-md-7 mb-3">
                    ...
                    <select class="form-control" v-validate="'required'" data-vv-name="Nombre" v-model="uno.nombre">
                      <template v-if="uno.tipo == 2">
                        <option :key="i" v-for="(b,i) in list_residuos_dos" :value="b">{{b.residuo.residuo}}</option>
                      </template>
                      <template v-if="uno.tipo == 1">
                        <option :key="i" v-for="(a,i) in list_residuos_uno" :value="a">{{a.residuo.residuo}}</option>
                      </template>
                    </select>
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <select class="form-control" data-vv-name="Area" v-validate="'required'" v-model="uno.area_proceso">
                      <option :key="i" v-for="(t,i) in uno.nombre.fuente" :value="t.fuente_generacion">{{t.fuente_generacion}}</option>
                    </select>
                ...
                <label>Destino</label>
                    <select class="form-control" v-model="destino">
                      <option selected value="1">Reuso</option>
                      <option value="2">Recicle</option>
                    </select>
                </div>
                </div>
                <hr>
