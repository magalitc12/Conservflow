    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <button data-toggle="collapse" href="#collapseDescargar" role="button" aria-expanded="false" aria-controls="collapseDescargar" class="btn btn-dark float-sm-right mr-1">
                    <i class="fas fa-file-pdf mr-1"></i>Descargar
                </button>
            </div>
            <div class="card-body">
                <div class="collapse multi-collapse" id="collapseDescargar">
                    <div class="container row">
                        <div class="col-md-3">
                            <div class="">
                                ...
                                <button @click="Descargar()" class="btn btn-dark mt-2">Generar</button>
                            </div>
                        </div>
                    </div>
                </div>
