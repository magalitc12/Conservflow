    ...
    <header>
        ...
        <table width="100%" class="tabe">
            ...
            <tr>
                ...
                <td class="borc">{{ $revision }}</td>
            </tr>
            <tr>
                <td class="borc">EMISIÓN</td>
                <td class="borc">{{ $emision }}</td>
            </tr>
        </table>
        ...
        <div style="page-break-after: always;">
            ...
            <table style="border-collapse:collapse; border: 2px solid;" width="100%">
                ...
                <tr>
                    ...
                    <td width="20%" class="letrat">&nbsp;{{ $analisis->numero_permiso }}</td>
                </tr>
                <tr>
            ...
            <table style="border-collapse:collapse; border: 2px solid;" width="100%">
                ...
                <tr>
                    ...
                    <td class="gris" width="27%">{{ $medidas_seguridad }}</td>
                    <td class="gris" width="15%">{{ $titulo_supervisor }}</td>
                    <td class="gris" width="15%">Firma</td>
                </tr>
                @foreach ($riesgos as $key => $value)
                    <tr>
                        <td class="letrat">&nbsp;{{ $key + 1 }}</td>
                        <td class="letrat">&nbsp;{{ $value->secuencia }}</td>
                        <td class="letrat">&nbsp;{!! nl2br($value->riesgo) !!}</td>
                        <td class="letrat">&nbsp;{!! nl2br($value->recomendacion) !!}</td>
                        <td class="letrat">&nbsp;{{ $value->supervisor }}</td>
                        <td class="letrat">&nbsp;</td>
                    </tr>
                @endforeach
            ...
            <div style="page-break-inside: avoid; width: 100%; bottom: 0px;">
                ...
                @if ($tipo == 1)
                    <table style="border-collapse:collapse; border: 2px solid;" width="100%">
                        <tr>
                            <td colspan="2" class="lc" style="border-bottom: 2px solid;">RESPONSABLES DE
                                AUTORIZACIÓN
                            </td>
                        </tr>
                        <tr>
                ...
                @elseif($tipo == 2)
                    <table style="border-collapse:collapse; border: 2px solid;" width="100%">
                        <tr>
                            <td colspan="2" class="lc" style="border-bottom: 2px solid;">
                        ...
                        <tr>
                            <td class="lp">{{ $analisis->operaciones_empleado }}
                                <br><br>
                                <br> Nombre y firma
                                <br><b>Responsable de Operaciones</b>
                            </td>
                            <td class="lp">{{ $analisis->shso_empleado }}
                                <br><br>
                                <br> Nombre y firma
                                <br><b>Responsable de SSMA</b>
                            </td>
                        </tr>
                    </table>
                @endif
