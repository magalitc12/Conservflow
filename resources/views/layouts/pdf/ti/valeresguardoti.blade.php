  ...
  <header>
    <table width="100%" style="border-collapse: collapse; border: 1px solid; font-family: Arial, Helvetica, sans-serif;
      ...
      <tr>
        ...
        <td style="font-weight: bold; border: 1px solid; text-align: center;" width="15%">CÓDIGO</td>
        <td style="border: 1px solid; text-align: center;" width="15%">PTI-01/F-02</td>
      </tr>
      <tr>
        <td style="font-weight: bold;border: 1px solid; text-align: center;">REVISIÓN</td>
        <td style="border: 1px solid; text-align: center;">00</td>
      </tr>
      <tr>
        <td style="font-weight: bold; border: 1px solid; text-align: center;">EMISIÓN</td>
  ...
  <main>
    <div>
      ...
      <table width="95%" style="padding-left: 50px; font-family: Arial, Helvetica, sans-serif;
        ...
        <tr>
          <td width="30%">
            @if (file_exists("administrativos/{{$data->empleado_entrega}}.png"))
            <img src="administrativos/{{$data->empleado_entrega}}.png" width="150px" height="100px">
            @endif
          </td>
          <td width="35%">&nbsp;</td>
          <td width="30%">
            @if($data->autorizado)
              @if (file_exists("administrativos/{{$data->empleado_recibe}}.png"))
                <img src="administrativos/{{$data->empleado_recibe}}.png" width="150px" height="100px">
              @endif
            @endif
          </td>
        </tr>
