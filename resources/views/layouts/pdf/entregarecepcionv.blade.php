...
<head>
  ...
  <title>PMN-02_F04 ENTREGA Y RECEPCIÓN DE PICK UP </title>
  <head>
  <style>
        ...
        <table width="100%" style="border-collapse: collapse; border: 1px solid; font-family: Arial, Helvetica, sans-serif;
          ...
          <td rowspan="3" style="border: 1px solid; text-align: center;" width="55%"><b>ENTREGA Y RECEPCIÓN DE PICK UP </b> </td>
          <td style="border: 1px solid; text-align: center;"  width="10%">CÓDIGO</td>
          <td style="border: 1px solid; text-align: center;"  width="15%">PMN-02/F-01</td>
          </tr>
          <tr>
