  ...
  <table width="100%" class="tab">
    <thead>
      <tr>
        ...
        <td class="bold" width="7%">Cantidad</td>
        <td class="bold">Compras</td>
        <td class="bold">Almacén</td>
        <td class="bold" width="10%">U.M.</td>
        <td class="bold" width="55%">Descripción</td>
        <td class="bold" width="">Marca</td>
        <td class="bold" width="">Documento Requerido</td>
        <td class="bold" width="">Fecha Requerida</td>
      </tr>
    </thead>
    ...
    <tr>
      ...
      <td>
        {{$partida['par']->descripcionarticulo != null ?
          $partida['par']->descripcionarticulo : $partida['par']->descripcionservicio}}
            &nbsp;
            {{ ($partida['par']->comentario != null ? (" - ".$partida['par']->comentario) : '')}}
      </td>
