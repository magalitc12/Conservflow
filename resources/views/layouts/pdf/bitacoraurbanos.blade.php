...
<head>
  ...
  <title>PSE-01_F-01 BITACORA DE RESIDUOS SOLIDOS URBANOS</title>
  <head>
  <style>
        ...
        <b>BITÁCORA DE RESIDUOS SÓLIDOS URBANOS</b> </td>
        <td style="border: 1px solid; text-align: center;"  width="10%">CÓDIGO</td>
        <td style="border: 1px solid; text-align: center;"  width="15%">PSE-02/F-01</td>
        </tr>
        <tr>
        ...
        <main>
            ...
            <td  style="border: 1px solid; background-color: #0070C0; text-align: center;"><div style="color:white;"><b>Proveedor que recolectó</b></div></td>
