...
<head>
  ...
  <table width="100%" style="text-align: center;" class="pdb">
    <tr>
      <td  width="30%"><b>Elabora:</b> </td>
      <td width="10%">&nbsp;</td>
      <td  width="35%"><b>Revisa:</b></td>
      <td width="10%">&nbsp;</td>
      <td  width="35%"><b>Autoriza:</b> </td>
    </tr>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td style="border-top: 1px solid;"><b>ANALISTA DE TESORERÍA</b></td>
    </tr>
  </table>
  </body>
</html>
