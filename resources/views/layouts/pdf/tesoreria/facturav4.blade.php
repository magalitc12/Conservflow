...
<body>
  ...
  <table style="font-family: Arial, sans-serif; font-size: 8px; width: 100%;">
    <tbody>
      ...
      <tr>
        ...
        <th style="background-color:transparent; font-weight: normal;">BASE: {{$value['partidas']->importe}}</th>
        <th style="background-color:transparent; font-weight: normal;">IMPORTE ${{round($value['partidas']->importe * $value['partidas']->retencion,2)}}</th>
  ...
  <table style="font-family: Arial, sans-serif; font-size: 8px; width: 100%;">
    <tbody>
      ...
      <tr>
        ...
        <td class="jus" style="text-align:right;">{{number_format($suma_partidas_pagos,2)}}</td>
  ...
  <table style="font-family: Arial, sans-serif; font-size: 8px; width: 100%;">
    <tbody>
      ...
      <tr>
        ...
        <td class="jus" style="text-align:right;">{{number_format($value->saldo_anterior,2)}}</td>
        <td class="jus" style="text-align:right;">{{number_format($value->importe_pagado,2)}}</td>
        <td class="jus" style="text-align:right;">{{number_format($value->saldo_insoluto,2)}}</td>
      </tr>
      <tr>
        <td colspan="7">
  ...
  <div style="page-break-inside: avoid; width: 100%; bottom: 0px;">
        ...
        <td>
          <table style="text-align: right; width:100%;">
            ...
            <tr>
              ...
              <td>{{((($suma_subtotal - $suma_descuento) + $suma_impuesto)- $suma_retencion)}}</td>
            </tr>
          </table>
        </td>
      </tr>
    ...
    <table style="width: 100%;">
      ...
      <td>
        <table width="100%">
          <!-- Solo si es real se muestra el QR -->
          @if(!$prueba)
    ...
    <p style=" font-family: Arial, sans-serif;  font-size: 10px; text-align:center;">ESTE DOCUMENTO ES UNA REPRESENTACION IMPRESA DE UN CFDI V4.0</p>
  </div>
