...
<head>
  ...
  <title>PSE-01_F-02 BITÁCORA DE ENTRADAS Y SALIDAS DE RESIDUOS PELIGROSOS</title>
  <head>
  <style>
        ...
        <td rowspan="3" style="border: 1px solid; text-align: center;" width="55%"><b>BITÁCORA DE ENTRADAS Y SALIDAS DE RESIDUOS PELIGROSOS</b> </td>
        ...
        <main>
            ...
            <tr>
            <td style="border: 1px solid; background-color: #BFBFBF; text-align: center;"><b> CRETIB</b></td>
            <td style="border: 1px solid; background-color: #BFBFBF; text-align: center;"><b> Fecha Salida</b></td>
            <td style="border: 1px solid; background-color: #BFBFBF; text-align: center;"><b> Proveedor</b></td>
            <td style="border: 1px solid; background-color: #BFBFBF; text-align: center;"><b> No. de Autorización</b></td>
            <td style="border: 1px solid; background-color: #BFBFBF; text-align: center;"><b> Clave CRETIB</b></td>
            <td style="border: 1px solid; background-color: #BFBFBF; text-align: center;"><b> Clave Generica</b></td>
            <td style="border: 1px solid; background-color: #BFBFBF; text-align: center;"><b> Núm. De Manifiesto</b></td>
            </tr>
