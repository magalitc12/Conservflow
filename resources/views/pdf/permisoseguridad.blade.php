...
<body >
  <div style="page-break-after: always;">
    <table style="border-collapse:collapse; border: 2px solid;" width="100%">
      ...
      <tr>
        <td class="hed">EMISIÓN</td>
        <td class="hed">07.FEB.23</td>
      </tr>
    </table>
    ...
    <table style="border-collapse:collapse; border: 2px solid;" width="100%">
      <tr>
        ...
        <td class="letrat">{{str_replace(["-E","-P"],"",$arreglo['uno']->uno)}}</td>
      ...
      <tr>
        ...
        <td class="letrat">{{str_replace(["-E","-T"],"",$arreglo['uno']->dos)}}</td>
      </tr>
      <tr>
...
<tr>
  <td colspan="7" class="lc"><div style="color: white;" height="15">3.REQUISITOS A CUMPLIR ANTES DE LA EJECUCION DEL TRABAJO
    <br>(marcar con una "X" o iniciales del responsable de SSMA según corresponda)</div></td>
  </tr>
  <tr>
    ...
    <td class=gris width="10%">CONFIRMACIÓN DE SSMA</td>
  ...
  <tr>
    <td class="letrag">Los materiales combustibles se encuentren fuera de un radio de 11 metros (35 pies) del área de trabajo.</td>
