...
<body>
  ...
  <header>
    <table width="100%" style="border-collapse: collapse; border: 1px solid; font-family: Arial, Helvetica, sans-serif;
      ...
      <tr>
        ...
        <td rowspan="3" style="border: 1px solid; text-align: center;" width="55%"><b>INVENTARIO DE UNIDADES</b> </td>
        <td style="border: 1px solid; text-align: center;" width="10%"><b>CÓDIGO</b></td>
        <td style="border: 1px solid; text-align: center;" width="15%">PMN-02 / F-04</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td style="border: 1px solid; text-align: center;">02.JUL.22</td>
      </tr>
    </table>
  ...
  <main>
    ...
    <table width="100%" style="border-collapse: collapse;  font-family: Arial, Helvetica, sans-serif; font-size: 8px;">
      <tr>
        <td rowspan="2" style="border: 1px solid; background-color: #0070C0; text-align: center;">
          <div style="color:white;">#</div>
        </td>
        <td rowspan="2" style="border: 1px solid; background-color: #0070C0; text-align: center;">
          <div style="color:white;">MARCA</div>
        </td>
        <td rowspan="2" style="border: 1px solid; background-color: #0070C0; text-align: center;">
          <div style="color:white;">MODELO</div>
        </td>
        <td rowspan="2" style="border: 1px solid; background-color: #0070C0; text-align: center;">
          <div style="color:white;">AÑO</div>
        </td>
        <td rowspan="2" style="border: 1px solid; background-color: #0070C0; text-align: center;">
          <div style="color:white;">PLACAS</div>
        </td>
        <td rowspan="2" style="border: 1px solid; background-color: #0070C0; text-align: center;">
          <div style="color:white;">ESTADO</div>
        </td>
        <td rowspan="2" style="border: 1px solid; background-color: #0070C0; text-align: center;">
          <div style="color:white;">COMPAÑÍA DE SEGUROS</div>
        </td>
        <td rowspan="2" style="border: 1px solid; background-color: #0070C0; text-align: center;">
          <div style="color:white;">NO. DE POLIZA DE SEGURO</div>
        </td>
        <td colspan="2" style="border: 1px solid; background-color: #0070C0; text-align: center;">
          <div style="color:white;">FECHA DE COBERTURA DEL SEGURO</div>
        </td>
      </tr>
      <tr>
