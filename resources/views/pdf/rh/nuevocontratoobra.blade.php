...
<body>
    ...
    <div class="main">
        <p class="text-center text-bold">CONTRATO INDIVIDUAL DE TRABAJO PARA OBRA DETERMINADA</p>
        <p>
            Que celebran por una parte la sociedad denominada CONSERFLOW, S.A. DE C.V. representada
            por el señor RAMON CRUZ MARTINEZ a quien lo sucesivo se denominará como la EMPRESA y/o
            EMPLEADOR, y por otra parte el (la) señor (a) {{ $contrato->empleado }} a quien en
            lo sucesivo se denominara como TRABAJADOR (A); quienes se obligan al tenor de las
        ...
        <p>3.- Que su objeto social es lícito y por así convenir a sus intereses, es su voluntad
            celebrar el presente contrato.</p>
        <p>4.- Que toda vez que en atención al desarrollo proyecto {{ $contrato->proyecto }}
            requiere mano de obra y/o servicios extra, ha decidido llevar a cabo la celebración
            del presente contrato.</p>

        <p class="text-bold">II.- DEL TRABAJADOR</p>

        <p>1.- Contar con plena capacidad para contratar y obligarse en términos del presente
            contrato, ser de nacionalidad mexicana, con edad de {{ $contrato->edad }} años,
            de sexo {{ $contrato->sexo == 0 ? 'Femenino' : 'Masculino' }} y que su
        ...
        <p>2.- Que es su voluntad celebrar el presente contrato laboral por así convenir a
            sus intereses. </p>
        <p>3.- Tener su domicilio en {{ $contrato->direccion }}.</p>
        <p>4.- Estar físicamente apto, así como contar con los conocimientos, habilidades y
            demás requisitos necesarios para desempeñar el puesto a que se refiere la clausula
            segunda de este contrato.</p>
        <p>5.- Designar como beneficiario a {{ $contrato->beneficiario }}, de acuerdo con la
            fracción X del artículo 24 de la Ley Federal del Trabajo, para el pago de los salarios y
            prestaciones devengadas y no cobradas a la muerte del trabajador o las que se
            generen por su fallecimiento o desaparición derivada de un acto delincuencial.</p>

        <p class="text-bold text-center">CLAUSULAS</p>
        <p><span class="text-bold">PRIMERA.- TIPO DE RELACIÓN LABORAL.- </span>
            Toda vez que como ha quedado establecido, la
            EMPRESA requiere mano de obra y/o servicios extra para el desarrollo del proyecto denominado
            {{ $contrato->proyecto }}, se ve en la necesidad de contratar personal para cumplir con los objetivos del
            mismo.</p>
        <p>Por lo tanto, las partes están de acuerdo en iniciar una relación laboral por obra determinada, con
            apego a lo establecido en los artículos 35 y 36 de la Ley Federal del Trabajo, por así requerirlo la
            naturaleza del trabajo.</p>
        <p>
            El inicio de este contrato será el día {{ $contrato->fecha_inicio }}, y la EMPRESA proyecta
            que el plazo para finalizar la obra objeto del contrato será con fecha {{ $contrato->fecha_fin }}.
        </p>
        <p>
            Concluida dicha obra o la parte correspondiente a los trabajos para la que es contratado el
            TRABAJADOR, la relación laboral se dará por terminada, situación ampliamente conocida y
            comprendida por el trabajador. Si por causas ajenas a la empresa llegara a suspenderse o
            cancelarse la obra para que es contratado el TRABAJADOR, este contrato se dará por terminado
            sin responsabilidad para la EMPRESA por haberse agotado el objeto de la relación laboral.
        </p>
        ...
        <p><span class="text-bold">SEGUNDA.- PUESTO DE TRABAJO.-</span> El TRABAJADOR prestará sus
            servicios para la empresa como {{ $contrato->puesto }}, cuyas funciones, obligaciones y
            responsabilidades le han sido informadas; debiendo desempeñar dicho trabajo con la
            intensidad, cuidado y esmero apropiados, bajo la dirección y subordinación de los
            representantes de la empresa.</p>
        <p><span class="text-bold">TERCERA.- FUNCIONES DEL TRABAJADOR.-</span>
            Las partes convienen que las principales labores
            del TRABAJADOR consistirán de manera enunciativa más no limitativa en lo conveniente al
            desarrollo del puesto asignado, por lo que el TRABAJADOR acepta también realizar todas aquellas
            que le sean encomendadas por sus superiores siempre que sean relacionadas a la actividad de la
            EMPRESA de acuerdo con las necesidades de productividad y desarrollo de ésta. El
            TRABAJADOR ratifica desde este momento su conformidad con esta condición de trabajo.</p>
        ...
        <p>El TRABAJADOR dará igual tratamiento a toda la información que llegue a conocer en relación con
            ...
            compañeros de trabajo más allá de lo estrictamente necesario para el desempeño de sus labores.</p>
        <p>
        ...
        <p><span class="text-bold">QUINTA.- CLAUSULA DE NO COMPETENCIA.-</span>
            El TRABAJADOR se obliga a no realizar por su
            cuenta ninguna labor adicional a la que desarrolla para la EMPRESA, en especial cualquiera que
            pudiera ser considerada como competencia, deslealtad o que conlleve un conflicto de intereses
            entre el TRABAJADOR y la EMPRESA. De igual manera se obliga a no negociar por su cuenta con
            los clientes de la empresa.</p>
        <p>El incumplimiento de esta obligación será considerado como causa especial de rescisión
            de este contrato, sin responsabilidad para la EMPRESA. Además, el TRABAJADOR asumirá la
            responsabilidad en la que incurra de conformidad con las leyes aplicables.</p>

        <p><span class="text-bold">SEXTA.- LUGAR DE TRABAJO.-</span>
            El TRABAJADOR se obliga a prestar sus servicios en el lugar
            que designe la EMPRESA que será el ubicado en {{ $contrato->ubicacion }}. El TRABAJADOR
            es conocedor de que para el desarrollo de la obra para la que es contratado, la empresa
            necesita de sus servicios en distintos lugares, por lo que otorga su consentimiento y
            autorización para que la empresa pueda en cualquier otro momento designar otro lugar para
            la prestación de servicios, dentro del territorio nacional de acuerdo con las necesidades
            de desarrollo y productividad de ésta, conforme a lo establecido por la Ley Federal
            del Trabajo.</p>
        ...
        <p><span class="text-bold">OCTAVA.- SALARIO.-</span>
            ...
            designado para el desarrollo de las actividades laborales, dentro de la jornada de trabajo.
            El TRABAJADOR autoriza a la EMPRESA a realizar las deducciones y/o retenciones legales
            que correspondan, mismas que serán desglosadas en los recibos que la EMPRESA entregue
            al TRABAJADOR.</p>
        ...
        <p><span class="text-bold">NOVENA. - JORNADA LABORAL.-</span>
            El TRABAJADOR laborará semanalmente 48 cuarenta y ocho horas.</p>
        ...
        <p>Lo anterior sin perjuicio de que la EMPRESA, de acuerdo con las necesidades de producción o de
            cualquier otra circunstancia pueda a su juicio cambiar dicho horario, pero respetando en todo caso
        ...
        <p><span class="text-bold">DECIMA.- TIEMPO DE DESCANSO Y PARA ALIMENTOS.-</span>
            La jornada laboral permitirá que el
            TRABAJADOR disfrute de un periodo para descansar y tomar sus alimentos fuera del centro de
            trabajo. El tiempo para ingestión de alimentos y descansar NO se computara como tiempo efectivo
            de trabajo.</p>

        <p><span class="text-bold">DECIMA PRIMERA.- CONTROL DE ASISTENCIA.-</span>
            El TRABAJADOR se obliga diariamente a
            firmar o marcar la hora de entrada y salida a sus labores, bajo el sistema que la EMPRESA
            establezca o llegue a establecer en el futuro, a fin de tener un control de tiempo y asistencia. El
            incumplimiento a esta obligación hará presumir a la EMPRESA la inasistencia del TRABAJADOR a
            su jornada laboral, pudiendo efectuar los correspondientes descuentos sobre el salario.</p>

        <p><span class="text-bold">DECIMA SEGUNDA.- DESCANSO SEMANAL.-</span>
        ...
        <p><span class="text-bold">DECIMA TERCERA.- DIAS DE DESCANSO OBLIGATORIO.-</span>
            Los días de descanso obligatorio serán los establecidos en articulo 74 la Ley Federal del
            Trabajo: I.- Primero de enero, II.- Primer lunes de febrero en conmemoración al cinco de
            febrero, III.- Tercer lunes de marzo en conmemoración al veintiuno de marzo, IV.-
            Primero de mayo, V.- Dieciséis de septiembre, VI.- Tercer lunes de noviembre en
            conmemoración al veinte de noviembre, VII.- El primero de diciembre cada seis años
            cuando corresponda a la transmisión del Poder Ejecutivo Federal, VIII.- El veinticinco
            de diciembre, y IX.- El que determinen las leyes federales y locales electorales,
            en el caso de elecciones ordinarias, para efectuar la jornada electoral.</p>

        <p><span class="text-bold">DÉCIMA CUARTA. - CAPACITACIÓN Y ADIESTRAMIENTO. -</span>
            La EMPRESA se compromete a otorgar capacitación y adiestramiento al TRABAJADOR,
            para elevar su nivel de vida y productividad en los términos de los planes y programas
            que se establezcan en la EMPRESA, de acuerdo con lo dispuesto por la Ley Federal del Trabajo.</p>
        <p>Atendiendo a la naturaleza del trabajo, esta capacitación se realizará fuera de la jornada de trabajo
            y será obligatoria para el TRABAJADOR.</p>
        <p>La capacitación tendrá como objeto actualizar y perfeccionar los conocimientos y habilidades del
            TRABAJADOR, incrementar la productividad, proporcionarle información sobre nueva tecnología y
            métodos aplicables a sus funciones, prevenir accidentes de trabajo y preparar al TRABAJADOR
            para ocupar otro puesto cuando exista vacante.</p>
        ...
        <p><span class="text-bold">DECIMA SÉPTIMA.- SEGURIDAD SOCIAL.-</span>
            La EMPRESA inscribirá o dará de alta
            oportunamente al TRABAJADOR ante el Instituto Mexicano del Seguro Social, obligándose el
            TRABAJADOR a permitir que la EMPRESA haga los descuentos en su salario que sean
            necesarios y tengan por objeto cubrir la cuota obrera ante el Instituto Mexicano del Seguro Social.
            Ambas partes se comprometen a cumplir con todo lo relatico a la Ley del Seguro Social y sus
            reglamentos.</p>

        <p><span class="text-bold">DÉCIMA OCTAVA.- RIESGOS DE TRABAJO.-</span>
            La EMPRESA inscribirá al TRABAJADOR dentro
            del régimen de Seguridad Social, por lo que todo lo relacionado con riesgos de trabajo y
            enfermedades o accidentes, se estará a lo dispuesto por la Ley Federal del Trabajo en la materia y
            sus reglamentos, sin responsabilidad alguna para la EMPRESA de tales enfermedades y
            accidentes. La EMPRESA Y el TRABAJADOR pagarán las cuotas que les correspondan.</p>
        ...
        <p>CCuando una TRABAJADORA se encuentre embarazada deberá informar a la empresa de su
        ...
        <p><span class="text-bold">VIGÉSIMA SEGUNDA.- INSTRUMENTOS DE TRABAJO.-</span>
            La EMPRESA se obliga a proporcionar al TRABAJADOR los equipos, artículos,
            procedimientos, manuales, catálogos, automóviles, información, herramientas, equipos de
            instrumentos y en general todas las facilidades necesarias para realizar su trabajo
            y a su vez el TRABAJADOR reconoce que son de la EMPRESA y se obliga a no usarlos para
            fines personales y a cuidarlos como propios, devolviéndolos a la EMPRESA cuando esta
            se los requiera.</p>
        ...
        <p><span class="text-bold">VIGÉSIMA TERCERA.- MOVILIDAD DE LAS CONDICIONES DE TRABAJO.-</span>
            ...
            TRABAJADOR, por lo que se podrá modificar, sin menoscabo del salario, cualquier condición
            de trabajo o la modalidad de la prestación del servicio, tales como el horario, distribución
            de la jornada semanal de trabajo, etc. Por lo anterior, el TRABAJADOR otorga desde ahora su
            consentimiento y conformidad expresa con esta posibilidad de cambios, que constituye una
            condición especial de la relación de trabajo.</p>

        <p><span class="text-bold">VIGÉSIMA CUARTA.- TRABAJO ANTE TERCEROS.-</span>
            Considerando que la EMPRESA le presta
            sus servicios a terceros, y que estos pudieran ser a través o por conducto del TRABAJADOR, las
            partes convienen expresamente que siempre se considerará que el TRABAJADOR esta prestando
            sus servicios para la EMPRESA conforme a este contrato, y que será la EMPRESA quién pagará
            su salario y a quien estará subordinado el TRABAJADOR, por lo que la relación laboral continuará
            exclusivamente entre ambos.</p>

        <p><span class="text-bold">VIGÉSIMA QUINTA.- NORMATIVIDAD INTERNA.-</span>
            El TRABAJADOR manifiesta conocer el
            contenido del Reglamento interior de trabajo de la EMPRESA, se obliga expresamente a cumplir
            con él y manifiesta haber recibido una copia del mismo. Se obliga a cumplir también con las
            circulares y órdenes verbales o escritas para la seguridad y protección de su persona y de sus
            bienes, así como de sus compañeros de trabajo y de los bienes de éstos.
        </p>
        <p>
            <span class="text-bold">VIGÉSIMA SEXTA.- CAUSAS DE RESCISIÓN DE CONTRATO.-</span>
            Ambas partes, acuerdan que la EMPRESA tendrá la facultad de Rescindir el presente contrato
            sin responsabilidad, cuando se actualice alguna de las causales establecidas por el artículo
            47 la Ley Federal del Trabajo, así como las expresamente acordadas en este contrato:
        </p>
        <p>
            I. Engañar el trabajador a la EMPRESA con certificados falsos o referencias en los que se
        ...
        <p><span class="text-bold">VIGÉSIMA SÉPTIMA.- TERMINACIÓN DE RELACIÓN LABORAL.-</span>
            El TRABAJADOR es
            ampliamente consiente de que concluida la obra descrita en la declaración cuatro de la EMPRESA
            o la parte correspondiente a los trabajos para la que es contratado, la relación laboral se dará por
            terminada. La obra puede no concluir precisamente el día señalado en la cláusula primera. Si la
            obra no ha concluido en la fecha estimada, este contrato no se entenderá por ampliado de manera
            indefinida sino simplemente hasta que el TRABAJADOR concluya el trabajo encomendado.</p>

        <p>La relación laboral puede concluir anticipadamente si por causas ajenas a la EMPRESA llegara a
            suspenderse o cancelarse la obra en mención. Lo anterior sin responsabilidad para la EMPRESA
            por haberse agotado el objeto de la relación laboral.</p>
        ...
        <p><span class="text-bold">VIGÉSIMA NOVENA.- </span>
            Todo lo que no está debidamente pactado en el presente contrato, se sujetará a la
