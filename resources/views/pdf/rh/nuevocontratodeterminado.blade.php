...
<body>
    ...
    <div class="main">
        <p class="text-center text-bold">CONTRATO INDIVIDUAL DE TRABAJO POR TIEMPO DETERMINADO</p>
        ...
        <p>
            4.- Que toda vez que en atención al desarrollo de diversos proyectos requiere mano de
            obra y/o servicios extra, ha decidido llevar a cabo la celebración del presente contrato.
        </p>
        ...
        <p>5.- Designar como beneficiario a {{ $contrato->beneficiario }}, de acuerdo con la
            fracción X del artículo 24 de la Ley Federal del Trabajo, para el pago de los salarios
            y prestaciones devengadas y no cobradas a la muerte del trabajador o las que se
        ...
        <p><span class="text-bold">PRIMERA. - TIPO DE RELACIÓN LABORAL. -</span>
            ...
            EMPRESA requiere mano de obra y/o servicios extra para el desarrollo de diversos
            proyectos y se ve en la necesidad de contratar personal para cumplir con los objetivos
            de los mismos. Por lo tanto, las partes están de acuerdo en iniciar una relación
            laboral por tiempo determinado, con apego a lo establecido en los artículos 35 y 36
            de la Ley Federal del Trabajo, por así requerirlo la naturaleza del trabajo.
        </p>
        <p>
            El inicio de este contrato será el día {{ $contrato->fecha_inicio }}, y el termino será
            el día {{ $contrato->fecha_fin }} vigencia que ampara el presente contrato, a cuyo
            efecto LA EMPRESA pondrá a disposición del TRABAJADOR, durante todo el tiempo de la
            prestación de sus servicios, los materiales, herramientas, y útiles necesarios para la realización de
            los trabajos y otros que se refieran.
        </p>
        <p>
            Culminado dicho periodo la relación laboral se dará por terminada, situación ampliamente conocida
            y comprendida por el trabajador esto sin que genere responsabilidad alguna para la EMPRESA por
            haberse agotado el objeto de la relación laboral.
        </p>
        <p>
            La relación laboral podrá modificarse, suspenderse, rescindirse o terminarse por voluntad de las
            partes o en términos de lo previsto por la Ley Federal del Trabajo.
        </p>
        <p>
        ...
        <p>La relación laboral podrá modificarse, suspenderse, rescindirse o terminarse por voluntad
            de las partes o en términos de lo previsto por la Ley Federal del Trabajo.</p>

        <p><span class="text-bold">SEGUNDA. - PUESTO DE TRABAJO. -</span>
            El TRABAJADOR prestará sus servicios para la empresa como {{ $contrato->puesto }},
            cuyas funciones, obligaciones y responsabilidades le han sido informadas; debiendo
            desempeñar dicho trabajo con la intensidad, cuidado y esmeros apropiados, bajo la
        ...
        <p><span class="text-bold">TERCERA. - FUNCIONES DEL TRABAJADOR. -</span>
            Las partes convienen que las principales
            labores del TRABAJADOR consistirán de manera enunciativa más no limitativa por lo que el
            TRABAJADOR acepta también realizar todas aquellas que le sean encomendadas por sus
            superiores siempre que sean relacionadas a la actividad de la EMPRESA de acuerdo con las
            necesidades de productividad y desarrollo de ésta. El TRABAJADOR ratifica desde este momento
            su conformidad con esta condición de trabajo.</p>
        ...
        <p><span class="text-bold">SEXTA.- LUGAR DE TRABAJO.-</span>
            El TRABAJADOR se obliga a prestar sus servicios en el lugar que designe la EMPRESA que
            será el ubicado en {{ $contrato->ubicacion }}.El TRABAJADOR es conocedor de que para el
            desarrollo de la obra para la que es contratado, la empresa necesita de sus servicios en
            distintos lugares, por lo que otorga su consentimiento y autorización para que la empresa
            pueda en cualquier otro momento designar otro lugar para la prestación de servicios,
            dentro del territorio nacional de acuerdo con las necesidades de desarrollo y
            productividad de ésta, conforme a lo establecido por la Ley Federal del Trabajo.</p>

        <p>EEl TRABAJADOR se obliga a permanecer en el lugar de prestación de servicios que le sea
        ...
        <p><span class="text-bold">OCTAVA.- SALARIO.-</span>
            El salario DIARIO del TRABAJADOR será de ${{ $contrato->sdi_letra }},
            que será pagado por {{ $contrato->tipo_nomina }} vencidas, en moneda de curso legal
            en el domicilio designado para el desarrollo de las actividades laborales, dentro de la jornada de
        ...
        <p>El TRABAJADOR autoriza a la EMPRESA para que por seguridad, se realice el pago de su
            salario a través del depósito bancario, conforme a lo establecido en el primer
            párrafo el artículo 101 de la Ley Federal del Trabajo.</p>
        ...
        <p><span class="text-bold">NOVENA.- JORNADA LABORAL.-</span>
            La jornada laboral de lunes a viernes iniciará a las 8:00 horas y se interrumpirá a las 13:00 horas a
            fin de que el TRABAJADOR pueda descansar y consumir sus alimentos, pudiendo para tal efecto
            salir del lugar de trabajo; la jornada se reanudará a las 15:00 horas y finalizará a las 18:00 horas.
            Los días sábados la jornada laboral iniciará a las 8:00 horas y finalizará a las 13:00 horas.
        </p>
        ...
        <p><span class="text-bold">DECIMA PRIMERA.- TIEMPO DE DESCANSO Y PARA ALIMENTOS.-</span>
        ...
        <p><span class="text-bold">DECIMA CUARTA.- CAPACITACIÓN Y ADIESTRAMIENTO.-</span>
            ...
            otorgar capacitación y adiestramiento al TRABAJADOR, para elevar su nivel de vida y
            productividad en los términos de los planes y programas que se establezcan en la EMPRESA, de
            acuerdo con lo dispuesto por la Ley Federal del Trabajo.</p>
        ...
        <p>
            Queda prohibido al trabajador: I. Ejecutar cualquier acto que pueda poner en peligro su propia
        ...
        <p><span class="text-bold">VIGÉSIMA.- PRIMA VACACIONAL.-</span>
            ...
            veinticinco por ciento sobre los salarios que le correspondan durante el periodo
            vacacional.</p>
        ...
        <p><span class="text-bold">VIGÉSIMA SEGUNDA.- INSTRUMENTOS DE TRABAJO.-</span>
            La EMPRESA se obliga a proporcionar al TRABAJADOR los equipos, artículos, procedimientos,
            manuales, catálogos, automóviles, información, herramientas, equipos de instrumentos
            y en general todas las facilidades necesarias para realizar su trabajo y a su vez el
            TRABAJADOR reconoce que son de la EMPRESA y se obliga a no usarlos para fines
            personales y a cuidarlos como propios, devolviéndolos a la EMPRESA cuando esta se los
            requiera.</p>
        <p>
            Cuando el EMPLEADOR no suministre directamente las herramientas de trabajo, al pagar el
            salario reintegrara al trabajador los gastos que hubiese hecho para allegarse de éstas a
            fin de no retrasar el trabajo.
        </p>
        <p><span class="text-bold">VIGÉSIMA TERCERA.- MOVILIDAD DE LAS CONDICIONES DE TRABAJO.-</span>
            La EMPRESA y el
            TRABAJADOR convienen en que, por las necesidades del servicio, producción y productividad,
            existirá flexibilidad o movilidad en las actividades que desempeñará el TRABAJADOR, por lo que
            se podrá modificar, sin menoscabo del salario, cualquier condición de trabajo o la modalidad de la
            prestación del servicio, tales como el horario, distribución de la jornada semanal de trabajo, etc. Por
            lo anterior, el TRABAJADOR otorga desde ahora su consentimiento y conformidad expresa con
            esta posibilidad de cambios, que constituye una condición especial de la relación de trabajo.
        </p>
        ...
        <p>
            ...
            EMPRESA tendrá la facultad de Rescindir el presente contrato sin responsabilidad, cuando se
            actualice alguna de las causales establecidas por el artículo 47 la Ley Federal del Trabajo, así
            como las expresamente acordadas en este contrato:
        </p>
        ...
        <p><span class="text-bold">VIGÉSIMA SÉPTIMA.- TERMINACIÓN DE RELACIÓN LABORAL.-</span>
            ...
            indefinida sino simplemente hasta que el TRABAJADOR concluya el trabajo encomendado.
        </p>
        <p>
            La relación laboral puede concluir anticipadamente si por causas ajenas a la EMPRESA llegara a
            suspenderse o cancelarse la obra en mención. Lo anterior sin responsabilidad para la EMPRESA
            por haberse agotado el objeto de la relación laboral.
        </p>
        ...
        <p><span class="text-bold">VIGÉSIMA OCTAVA.-</span>
            ...
            estar capacitado y contar con las aptitudes necesarias para el desarrollo de éstas.
        </p>
